...
function _createAudio() {
  _createAudio = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          from = _args.length > 0 && _args[0] !== undefined ? _args[0] : './src/client/posts/';
          to = _args.length > 1 && _args[1] !== undefined ? _args[1] : './src/client/audio/';
          _context.next = 4;
          return Promise.resolve(/* import() | audio */).then(__webpack_require__.bind(__webpack_require__, 272));
        case 4:
...
function _createSitemap() {
  _createSitemap = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          SAVETO = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : './src/client/posts/';
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          verbose = _args4.length > 3 && _args4[3] !== undefined ? _args4[3] : false;
          _context4.next = 4;
          return external_fs_.stat(directory);
        case 4:
          stat = _context4.sent;
          if (stat.isDirectory()) {
            _context4.next = 8;
        ...
        case 8:
          _context4.next = 10;
          return external_fs_.readdir(directory);
        case 10:
              ...
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    _context3.t0 = JSON;
                    _context3.next = 4;
                    return external_fs_.readFile(filePath, 'utf-8');
                  case 4:
...
function _cli_nbs2html() {
  _cli_nbs2html = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    var FROM,
      directory,
      SAVETO,
      verbose,
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          FROM = _args5.length > 0 && _args5[0] !== undefined ? _args5[0] : './src/ipynb/';
          directory = _args5.length > 1 ? _args5[1] : undefined;
          SAVETO = _args5.length > 2 && _args5[2] !== undefined ? _args5[2] : './src/client/posts/';
          verbose = _args5.length > 3 && _args5[3] !== undefined ? _args5[3] : false;
          // Search the pathto directory for .ipynb files
          verbose && console.log("\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ cli_nbs2html: start: ".concat(FROM).concat(directory, "/"));
          _context5.next = 7;
          return external_fs_.stat("".concat(FROM).concat(directory, "/"));
        case 7:
          stat = _context5.sent;
          if (stat.isDirectory()) {
            _context5.next = 11;
        ...
        case 11:
          _context5.next = 13;
          return external_fs_.readdir("".concat(FROM).concat(directory, "/"));
        case 13:
...
function generate_sectionmap(_x3, _x4, _x5, _x6) {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          _context6.prev = 5;
          _context6.next = 8;
          return external_fs_.access("".concat(SAVETO).concat(directory));
        case 8:
          _context6.next = 24;
          break;
        case 10:
          ...
          _context6.prev = 13;
          _context6.next = 16;
          return external_fs_.mkdir("".concat(SAVETO).concat(directory), {
            recursive: true
          });
        case 16:
          _context6.next = 21;
        ...
        case 62:
          ...
          _context6.prev = 63;
          _context6.next = 66;
          return external_fs_.writeFile(sitemapPath, JSON.stringify(links));
        case 66:
          _context6.next = 73;
          break;
        case 68:
          ...
          _context6.next = 72;
          return external_fs_.writeFile(sitemapPath, "{}");
        case 72:
...
function ipynb_publish(_x7, _x8) {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          ...
          _context7.next = 4;
          return Promise.resolve(/* import() | convert */).then(__webpack_require__.bind(__webpack_require__, 608));
        case 4:
        ...
        case 9:
          ...
          txt = pyCode.join('\n').replace(/(^|\n) /g, '$1');
          _context7.next = 18;
          return external_fs_.writeFile(pyCodeFilePath, txt);
        case 18:
          ...
          _context7.prev = 20;
          _context7.next = 23;
          return external_fs_.writeFile(t, type === "json" ? JSON.stringify(_final) : _final);
        case 23:
          _context7.next = 28;
          break;
        case 25:
