...
- `createSitemap(search, sitemapFile, pathPrefix, domain, verbose)`: Generates sitemaps for web navigation. Supports optional path prefix for subdirectory deployment and optional domain prefixing.
